...
<?php if(isset($_SESSION['UserLogin'])){?>
    ...
    $con = connection();
     $sql = "INSERT INTO tblclearance( id, firstname, middlename, lastname, age, purokno, purpose, status,requesterId) VALUES 
     ('','$firstname', '$middlename','$lastname', '$age', '$purok' , '$purpose','$status','$requesterId')";

     if ($con->query($sql) === TRUE) {
        echo '<script>alert("Submitted")</script>';
        echo'<script>window.location.href = "user_clearance.php"</script>';
      } else {
...
<main class="img">
  ...
  <div class="container">
    ...
    <input type="text" placeholder="Purpose of request form" name="purpose" id="purpose">
