...
<?php 
    ...
    $con = connection();
     $sql = "INSERT INTO reservation( organization_name,name_of_event,description, status, date, start_from, end_to,requesterId) VALUES ('$organization', '$event', '$description','$status', '$date', '$timestart' , '$timeend','$requesterId')";
