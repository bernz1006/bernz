<?php  if(!isset($_SESSION)){session_start();}
        include_once("../connections/connection.php");
            $con = connection(); 
$sql = "SELECT * FROM tblindigency ORDER BY id ASC ";
...
<div class="wrapper">
  <center><h1>Requesting of Barangay Indigency</h1></center>
  <br><br><br><br><br>
</div>
  <style>
    .container{
...
<div class="container">
  <div class="row">
    ...
    <div>
    <form id="go" action="indigency/brgy_indigency1.php">
...
if(mysqli_num_rows($result)>0){
	while ($row=mysqli_fetch_assoc($result)) {
		?>	 <tr>
        <td><a href="indigency/brgy_indigency.php?ID=<?php echo $row['id'];?>"><input type="button" id="request"  value="Request"></input></a></td>
