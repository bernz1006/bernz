...
<br>
<p class="p3"><input type="text" name="two" id="two2" value="<?php echo $row['name'];?>"></p>
<p class="p4">Name of Business / OWNER</p><br>
<p class="p5">PUROK <input type="text" name="two" id="two3" value="<?php echo $row['purok'];?>"> ,BARANGAY ATATE, PALAYAN CITY</p>
<div class="line-2"></div>
<p class="p6">Business Address/Office Address</p>
<br>
<p class="p3"><input type="text" name="two" id="two4" value="<?php echo $row['type'];?>"></p>
