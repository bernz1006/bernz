<?php  if(!isset($_SESSION)){session_start();}
        include_once("../connections/connection.php");
            $con = connection(); 
$sql = "SELECT * FROM tblclearance ORDER BY id ASC ";
...
<div class="wrapper">
  <center><h1>Requesting of Bargangay Clearance</h1></center>
  <br><br><br><br><br>
</div>
  <style>
    .container{
...
<div class="container">
  <div class="row">
    ...
    <div>
    <form id="go" action="clearance/brgy_clearance1.php">
...
if(mysqli_num_rows($result)>0){
	while ($row=mysqli_fetch_assoc($result)) {
		?>	 <tr>
        <td><a href="clearance/brgy_clearance.php?ID=<?php echo $row['id'];?>"><input type="button" id="request"  value="Request"></input></a></td>
