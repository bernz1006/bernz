...
<div class="main"> 
    ...
    <p class="sec2">(First Time Jobseekers Assistance Act - RA 11261)</p>
       ...
       , a resident of PUROK <input type="text" name="two" id="two2" value="<?php echo $row['purokno'];?>"> ,<b>BARANGAY ATATE  
        <p class="p1">PALAYAN CITY NUEVA ECIJA</b> for <b><input type="text" name="two" id="two2" value="<?php echo $row['years'];?>"> 
        years and <input type="text" name="two" id="two2" value="<?php echo $row['month'];?>"> months</b>, is a qualified availee 
