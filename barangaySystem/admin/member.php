...
<?php if(isset($_SESSION['UserLogin'])){?>
    ...
    $con = connection();
     ...
     ('$household','$purok', '$fname','$mname','$lname','$position','$relation','$gender','$status','$religion','$dbirth','$bplace','$age','$school','$educ','$employment','$occupation','$income')";
...
<main>
        ...
        <div class="">
                                   ...
                                   <label>Member Name:</label><br>
                                    ...
                                    <div class="">
                                   <label>Relation to Head Family:</label><br>
                                            <input name="txt_relation" class="" type="text" placeholder="Relation to Head Family"/>
                                    </div>
                                    <div class="">     
