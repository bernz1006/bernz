...
<div class="main"> 
    <p class="sec">BARANGAY CERTIFICATE OF INDIGENCY</p>
      ...
      <p class="p2">This is to certify that <input type="text" name="two" id="two"> of legal age, is a</p>
     ...
     <p class="p3">Moral Character and an Active Member of the Community. She/He is one of</p>
        ...
        <p class="p3">person for <input type="text" name="two" id="two"> purpose/s.</p><br>
